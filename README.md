...
14. Desafio de Implementação: O seu primeiro passo será extrair o contexto de Pagamento. Aplique os princípios de DDD e o padrão de migração escolhido para implementar a estrutura inicial desse novo microserviço em Java. Em seu documento, insira os blocos de código demonstrando: A classe do seu novo Aggregate Root de Pagamento; Como esse novo microsserviço se comunicará com o monolito legado (ex: uma interface ou serviço de integração), garantindo o baixo acoplamento.
